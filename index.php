...
<div class="panel panel-primary">
	<div class="panel-heading" style="font-size: 16px">My Contacts</div>
</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" value="<?php echo $cname; ?>" class="form-control" id="e-companyname<?php echo $id; ?>" placeholder="Enter Company Name">
...
<script type="text/javascript">
	...
	$('button#edit').click(function(e){
		...
		else if(e_phonenumber.length != 11){
		...
		// check if there are no js errors and send to server
